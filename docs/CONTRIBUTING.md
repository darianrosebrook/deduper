...
1. Read `docs/initial_plan.md`, `docs/IMPLEMENTATION_GUIDE.md`, and the relevant module’s `CHECKLIST.md` + `IMPLEMENTATION.md`.
2. If behavior/types change, update docs first (and `docs/ambiguities.md` if clarifying a decision).
...
- Use the harness (see `docs/18-benchmarking/`).
...
- See `docs/agents.md` for agent operating rules and `docs/ambiguities.md` to track decisions.
