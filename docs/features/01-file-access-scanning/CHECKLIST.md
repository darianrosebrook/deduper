...
- Read `docs/architecture/AGENTS.md` first. Update this checklist and the module IMPLEMENTATION.md before writing code.
- Every item must have corresponding tests (Unit/Integration/E2E) listed under Verification when implemented.
- Follow the Implementation Roadmap order in `docs/project/initial_plan.md`.
...
- [x] Resolve ambiguities (see `../../../development/ambiguities.md#01--file-access--scanning`).
- [x] Bookmark Manager
...
- See also: `../../../development/COMMON_GOTCHAS.md`.
