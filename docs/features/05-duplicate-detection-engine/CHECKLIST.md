...
- [x] Resolve ambiguities (see `../../../development/ambiguities.md#05--duplicate-detection-engine`).
- [x] Resolve ambiguities (see `../../../development/ambiguities.md#05--duplicate-detection-engine`); record weights per signal.
